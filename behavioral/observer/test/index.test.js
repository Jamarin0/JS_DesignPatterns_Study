...
describe('Test Suite for Observer Pattern', () => {
    ...
    test('#PaymentSybject notify observers', () => { 
    ...
    test('#PaymentSybject should not notify unsubscribed observers', () => {
        const subject = new PaymentSubject()
        const observer = {
            update: jest.fn()
        }     
    ...
    test('#Payment should notify subject after a credit card transaction', () => {
        ...
        const data = { userName: 'epicteto', id: Date.now() }
    ...
    test('#All should notify subscribers after a credit card payment', () => {
        ...
        const payment = new Payment(subject)
        const data = {userName: 'seneca', id: Date.now()}
        payment.creditCard(data)
