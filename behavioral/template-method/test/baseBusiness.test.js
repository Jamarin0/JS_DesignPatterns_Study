...
describe('#BaseBusiness', () => {
    ...
    test('should throw an error when child class doesnt implement _validateRequiredFields fuction', () => {
    ...
    test('should throw an error when child _validateRequiredFields return false', () => {
    ...
    test('should throw an error when child class doesnt implement _create fuction', () =>{
