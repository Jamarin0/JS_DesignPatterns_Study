...
const postgresConnectionString = "postgres://jamarinoogrande:senha0001@localhost:5432/heroes"
...
const mongoDBConnectionString = "mongodb://carlosmagma:senhaadmin@localhost:27017/heroes"
const mongoDBContext = new ContextStrategy(new MongoDBStrategy(mongoDBConnectionString))
await mongoDBContext.connect()


const data = [{
    name: 'jamarinoogrande',
    type: 'transaction'
}, {
    name: 'marcoaurelio',
    type: 'activityLog'
